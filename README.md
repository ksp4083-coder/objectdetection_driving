# 객체 검출 모델 학습: 도로 주행
- [2024년 자율주행 인공지능 알고리즘 개발 챌린지](https://challenge.gcontest.co.kr/template/m/frame/info1/16335)([대회 규칙](https://challenge.gcontest.co.kr/template/m/frame/info2/16335))에 개인으로 참가해 진행한 프로젝트입니다.
...
## YOLO란?
- You Only Look Once의 약자로 한번만 본 객체 검출 모델 학습: 도로 주행
